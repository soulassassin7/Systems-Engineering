...
ThreadPool::~ThreadPool(){
	...
	// before destructing we want all the worker threads to complete
	// otherwise the crash std::terminate will be caused if threads are still running
	// this for loop does that it makes the program wait till all are complete
