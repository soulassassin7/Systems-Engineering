...
int main(){
...

	{
		...
		SharedPtr<Player> p2 = p1;
		std::cout<<"Hp via P2: "<<p2->hp<<std::endl;
		std::cout<<"Score via P2: "<<p2->score<<std::endl;
	}
	std::cout<<"--- Back in Main ---"<<std::endl;
	std::cout<<"Hp via P1: "<<p1->hp<<std::endl;
	std::cout<<"Score via P1: "<<p1->score<<std::endl;
