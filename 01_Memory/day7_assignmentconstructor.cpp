...
int main(){
	...
	SharedPtr<Player> p2((Player*)MyMalloc(sizeof(Player)));
	p2->hp = 200;
	p2->score = 15000;
	
	std::cout<<"--- Assignment (P2 = P1) ---"<<std::endl;
	p2 = p1;
	
	std::cout<<"--- Verification ---"<<std::endl;
	std::cout<<"Hp of P1: "<<p1->hp<<std::endl;
	std::cout<<"Score of P1: "<<p1->score<<std::endl;
	std::cout<<"Hp of P2: "<<p2->hp<<std::endl;
	std::cout<<"Score of P2: "<<p2->score<<std::endl;
